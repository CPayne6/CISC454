...

{
  ...
  // Declare the drawBuffers.  This tells openGL which texture stores
  // each output of the fragment shader.
...
// Attach a texture to a texture unit
...
// Tell OpenGL into which textures to write the fragment shader
// outputs.
