...

{
  ...
  // vertex.
  //
  // The special value of 0 for this parameter means that the
  // attributes are tightly packed, one after another in the buffer.
  ...
  // Attribute 1 is colour
  //
  // Note tha 3*sizeof(float) is the offset, in bytes, from the start
  // of the buffer to attribute 1 of the first vertex
